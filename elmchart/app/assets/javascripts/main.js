...
var _jweir$elm_iso8601$ISO8601_Extras$calendar = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
...
var _jweir$elm_iso8601$ISO8601_Extras$isLeapYear = function (year) {
...
var _jweir$elm_iso8601$ISO8601_Extras$daysInMonth = F2(
	function (year, monthInt) {
		var calMonth = A2(_elm_lang$core$Array$get, monthInt - 1, _jweir$elm_iso8601$ISO8601_Extras$calendar);
		var _p1 = calMonth;
		if (_p1.ctor === 'Just') {
			return _jweir$elm_iso8601$ISO8601_Extras$isLeapYear(year) ? _p1._0._2 : _p1._0._1;
		} else {
			return 0;
		}
	});
var _jweir$elm_iso8601$ISO8601_Extras$daysToMonths = F3(
	function (year, startMonth, remainingDays) {
		daysToMonths:
		while (true) {
			var remainingDays_ = remainingDays - A2(_jweir$elm_iso8601$ISO8601_Extras$daysInMonth, year, startMonth);
...
var _jweir$elm_iso8601$ISO8601_Extras$daysInYear = function (year) {
	return _jweir$elm_iso8601$ISO8601_Extras$isLeapYear(year) ? 366 : 365;
};
var _jweir$elm_iso8601$ISO8601_Extras$yearsToDays = F3(
	function (ending, current, days) {
		...
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(ending, current) > 0) {
				var _v5 = ending,
					_v6 = current + 1,
					_v7 = _jweir$elm_iso8601$ISO8601_Extras$daysInYear(current);
				ending = _v5;
				current = _v6;
				days = _v7;
...
var _jweir$elm_iso8601$ISO8601_Extras$toInt = function (str) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
...
var _jweir$elm_iso8601$ISO8601_Extras$After = {ctor: 'After'};
var _jweir$elm_iso8601$ISO8601_Extras$Before = {ctor: 'Before'};
var _jweir$elm_iso8601$ISO8601_Extras$daysToYears = F3(
	function (rel, startYear, remainingDays) {
		daysToYears:
		while (true) {
			var _p2 = rel;
			if (_p2.ctor === 'After') {
				var remainingDays_ = remainingDays - _jweir$elm_iso8601$ISO8601_Extras$daysInYear(startYear);
				if (_elm_lang$core$Native_Utils.cmp(remainingDays_, 0) > 0) {
					var _v9 = _jweir$elm_iso8601$ISO8601_Extras$After,
						_v10 = startYear + 1,
						_v11 = remainingDays_;
					rel = _v9;
					startYear = _v10;
				...
				var remainingDays_ = remainingDays + _jweir$elm_iso8601$ISO8601_Extras$daysInYear(startYear);
				if (_elm_lang$core$Native_Utils.cmp(remainingDays_, 0) < 0) {
					var _v12 = _jweir$elm_iso8601$ISO8601_Extras$Before,
						_v13 = startYear - 1,
						_v14 = remainingDays_;
					rel = _v12;
					startYear = _v13;
					...
					return {
						ctor: '_Tuple2',
						_0: startYear,
						_1: _jweir$elm_iso8601$ISO8601_Extras$daysInYear(startYear) + remainingDays
					};
				}
			}
		}
...
var _jweir$elm_iso8601$ISO8601$offsetToMS = function (offset) {
	var _p0 = offset;
	var hour = _p0._0;
	var minutes = _p0._1;
	return _elm_lang$core$Basics$toFloat((((hour * 60) * 60) * 1000) + ((minutes * 60) * 1000));
};
...
var _jweir$elm_iso8601$ISO8601$validateTime = function (time) {
	var maxDays = _jweir$elm_iso8601$ISO8601_Extras$daysInMonth;
	return ((_elm_lang$core$Native_Utils.cmp(time.month, 1) < 0) || (_elm_lang$core$Native_Utils.cmp(time.month, 12) > 0)) ? _elm_lang$core$Result$Err('month is out of range') : (((_elm_lang$core$Native_Utils.cmp(time.day, 1) < 0) || (_elm_lang$core$Native_Utils.cmp(
		time.day,
		A2(_jweir$elm_iso8601$ISO8601_Extras$daysInMonth, time.year, time.month)) > 0)) ? _elm_lang$core$Result$Err('day is out of range') : _jweir$elm_iso8601$ISO8601$validateHour(time));
};
var _jweir$elm_iso8601$ISO8601$parseOffset = function (timeString) {
	...
	_v1_2:
	do {
		if (((((_p2.ctor === '::') && (_p2._0.ctor === '::')) && (_p2._0._0.ctor === 'Just')) && (_p2._0._1.ctor === '::')) && (_p2._0._1._0.ctor === 'Just')) {
			if (_p2._0._1._1.ctor === '::') {
				if (((_p2._0._1._1._0.ctor === 'Just') && (_p2._0._1._1._1.ctor === '[]')) && (_p2._1.ctor === '[]')) {
					return {
						ctor: '_Tuple2',
						_0: _jweir$elm_iso8601$ISO8601_Extras$toInt(
							A2(setHour, _p2._0._0._0, _p2._0._1._0._0)),
						_1: _jweir$elm_iso8601$ISO8601_Extras$toInt(_p2._0._1._1._0._0)
					};
				} else {
					break _v1_2;
				}
...
var _jweir$elm_iso8601$ISO8601$fromString = function (s) {
	var unwrap = F2(
		function (x, d) {
			return _jweir$elm_iso8601$ISO8601_Extras$toInt(
	...
	var _p5 = parts;
	if ((((((((((((_p5.ctor === '::') && (_p5._0.ctor === '::')) && (_p5._0._1.ctor === '::')) && (_p5._0._1._1.ctor === '::')) && (_p5._0._1._1._1.ctor === '::')) && (_p5._0._1._1._1._1.ctor === '::')) && (_p5._0._1._1._1._1._1.ctor === '::')) && (_p5._0._1._1._1._1._1._1.ctor === '::')) && (_p5._0._1._1._1._1._1._1._1.ctor === '::')) && (_p5._0._1._1._1._1._1._1._1._1.ctor === '::')) && (_p5._0._1._1._1._1._1._1._1._1._1.ctor === '[]')) && (_p5._1.ctor === '[]')) {
		var _p6 = _p5._0._1._1._1._1._1._1._1._1._0;
		if (_p6.ctor === 'Just') {
			return _elm_lang$core$Result$Err('unexpected text');
		} else {
			return _jweir$elm_iso8601$ISO8601$validateTime(
				{
					year: A2(unwrap, _p5._0._0, '0'),
					month: A2(unwrap, _p5._0._1._0, '1'),
					day: A2(unwrap, _p5._0._1._1._0, '1'),
					hour: A2(unwrap, _p5._0._1._1._1._0, '0'),
					minute: A2(unwrap, _p5._0._1._1._1._1._0, '0'),
					second: A2(unwrap, _p5._0._1._1._1._1._1._0, '0'),
					millisecond: _jweir$elm_iso8601$ISO8601$parseMilliseconds(_p5._0._1._1._1._1._1._1._0),
					offset: _jweir$elm_iso8601$ISO8601$parseOffset(_p5._0._1._1._1._1._1._1._1._0)
				});
		}
	} else {
...
var _jweir$elm_iso8601$ISO8601$toTime = function (time) {
	...
	if (_p10 === false) {
		var totalDays = _elm_lang$core$List$sum(
			A2(
				_elm_lang$core$List$map,
				_jweir$elm_iso8601$ISO8601_Extras$daysInMonth(time.year),
				A2(_elm_lang$core$List$range, 1, time.month)));
		var years = A2(
			_elm_lang$core$List$map,
			_jweir$elm_iso8601$ISO8601_Extras$daysInYear,
		...
		var tots = {
			...
			_1: {
				ctor: '::',
				_0: _jweir$elm_iso8601$ISO8601$iday * (_jweir$elm_iso8601$ISO8601_Extras$daysInYear(time.year) - totalDays),
				_1: {
					ctor: '::',
					_0: _jweir$elm_iso8601$ISO8601$iday * (A2(_jweir$elm_iso8601$ISO8601_Extras$daysInMonth, time.year, time.month) - time.day),
					_1: {
						ctor: '::',
		...
		return _elm_lang$core$Basics$toFloat(
			0 - (_elm_lang$core$List$sum(tots) - time.millisecond));
	} else {
		var months = A2(
			_elm_lang$core$List$map,
			_jweir$elm_iso8601$ISO8601_Extras$daysInMonth(time.year),
		...
		return _elm_lang$core$Basics$toFloat(
			_elm_lang$core$List$sum(tots) + time.millisecond);
	}
};
var _jweir$elm_iso8601$ISO8601$diff = F2(
	function (a, b) {
		return _jweir$elm_iso8601$ISO8601$toTime(a) - _jweir$elm_iso8601$ISO8601$toTime(b);
	});
var _jweir$elm_iso8601$ISO8601$fromTime = function (msFloat) {
	var ms = _elm_lang$core$Basics$round(msFloat);
	var milliseconds = A2(_elm_lang$core$Basics_ops['%'], ms, _jweir$elm_iso8601$ISO8601$isec);
	var v = (_elm_lang$core$Native_Utils.cmp(ms, 0) > -1) ? _jweir$elm_iso8601$ISO8601_Extras$After : _jweir$elm_iso8601$ISO8601_Extras$Before;
	var _p11 = v;
	if (_p11.ctor === 'After') {
		...
		var _p12 = A3(_jweir$elm_iso8601$ISO8601_Extras$daysToYears, _jweir$elm_iso8601$ISO8601_Extras$After, 1970, days);
		var years = _p12._0;
		var remainingDays = _p12._1;
		var _p13 = A3(_jweir$elm_iso8601$ISO8601_Extras$daysToMonths, years, 1, remainingDays + 1);
		var month = _p13._0;
		...
		var _p14 = _elm_lang$core$Native_Utils.eq(rem, 0) ? A3(_jweir$elm_iso8601$ISO8601_Extras$daysToYears, _jweir$elm_iso8601$ISO8601_Extras$Before, 1969, totalDays + 1) : A3(_jweir$elm_iso8601$ISO8601_Extras$daysToYears, _jweir$elm_iso8601$ISO8601_Extras$Before, 1969, totalDays);
		var years = _p14._0;
		var remainingDays = _p14._1;
		var _p15 = A3(_jweir$elm_iso8601$ISO8601_Extras$daysToMonths, years, 1, remainingDays);
		var month = _p15._0;
...
var _jweir$elm_iso8601$ISO8601$fromTimeWithOffset = F2(
	function (offset, unix) {
		var $new = _jweir$elm_iso8601$ISO8601$fromTime(
			unix + _jweir$elm_iso8601$ISO8601$offsetToMS(offset));
		return _elm_lang$core$Native_Utils.update(
			$new,
			{offset: offset});
	});
var _jweir$elm_iso8601$ISO8601$sub = F2(
	function (time, amount) {
		return A2(
			_jweir$elm_iso8601$ISO8601$fromTimeWithOffset,
			time.offset,
			_jweir$elm_iso8601$ISO8601$toTime(time) - amount);
	});
var _jweir$elm_iso8601$ISO8601$add = F2(
	function (time, amount) {
		return A2(
			_jweir$elm_iso8601$ISO8601$fromTimeWithOffset,
			time.offset,
...
var _jweir$elm_iso8601$ISO8601$weekday = function (time) {
	var daysSinceEpoch = (_elm_lang$core$Basics$round(
		_jweir$elm_iso8601$ISO8601$toTime(
			_elm_lang$core$Native_Utils.update(
				_jweir$elm_iso8601$ISO8601$defaultTime,
				{year: time.year, month: time.month, day: time.day}))) / _jweir$elm_iso8601$ISO8601$iday) | 0;
	var daysFromEpoch = _elm_lang$core$Array$fromList(
		{
			ctor: '::',
	...
	var day = A2(
		...
		A2(_elm_lang$core$Basics_ops['%'], daysSinceEpoch, 7),
		daysFromEpoch);
	var _p16 = day;
	if (_p16.ctor === 'Just') {
		return _p16._0;
